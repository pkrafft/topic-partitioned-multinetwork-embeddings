...
/**
 * Run an experiment with the Bernoulli model formulation presented in Krafft et
 * al. (2012).
 */
public class ConditionalStructureBernoulliExperiment extends Experiment {

	{
		options.getOption("num-latent-dims").setRequired(false);
	}

	public ConditionalStructureBernoulliExperiment(String[] args) {
		super(args);
	}
	...
	public static JointTextNetworkModel main(String[] args, LogRandoms rng)
		...
		Experiment experiment = new ConditionalStructureBernoulliExperiment(
				args);
