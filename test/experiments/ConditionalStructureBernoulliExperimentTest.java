...
public class ConditionalStructureBernoulliExperimentTest extends ExperimentTest {
	...
	public JointTextNetworkModel initializeModel(LogRandoms rng) {
		...
		JointTextNetworkModel model = new JointTextNetworkModel(emails, T, -1,
				rng, true, true, false, true, false, false, false, false, false, false, false, null);
	...
	public JointTextNetworkModel runExperiment(String[] args, LogRandoms rng)
			throws IOException {
		return ConditionalStructureBernoulliExperiment.main(args, rng);
	}
